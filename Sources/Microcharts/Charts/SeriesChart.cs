...
namespace Microcharts
{
    ...
    public abstract class SeriesChart : Chart
    {
        ...
        protected virtual void UpdateSeries(List<ChartSerie> value)
        {
        ...
        protected virtual void GenerateDefaultSerie(List<ChartEntry> value)
        {
            UpdateSeries(new List<ChartSerie>
            {
                new ChartSerie()
                {
                    Entries = value,
